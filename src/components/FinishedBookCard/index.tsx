...
export const FinishedBookCard = ({ image, name, author, progress, type }: { image: string, name: string, author: NamedCurve, progress: string, type: string }) => {
    return (
        <div className="flex-shrink-0 w-96 bg-gray-100 relative p-4 rounded-md shadow-md flex items-start gap-3 overflow-hidden select-none cursor-pointer transition-all hover:scale-105 hover:shadow-lg">
